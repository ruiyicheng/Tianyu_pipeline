...
class process_publisher:
    ...
    def publish_CMD(self,process_site,CMD,dep_PID_list):
        ...
        sql = "INSERT INTO process (process_id,process_cmd,process_status_id,process_site_id) VALUES (%s, %s,1,%s)"
    ...
    def test(self,item = 'stacking'):
        if item =="stacking":
            print(self.stacking(1,[self.publish_CMD(1,"capture",[]) for i in range(35)]))
