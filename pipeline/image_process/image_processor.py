...
class image_processor:
    ...
    #     self.pp_this_site = process_pub.process_publisher(site_id = site_id, group_id = site_id)
    ...
    def calibration(self,process_PID,site_id, sub_img_pid = -1, div_img_pid = -1,subtract_bkg = True,debug = True):#,obs_id=1,hierarchy=2,img_type = "flat_raw",consider_flat = True,consider_bias = True,bias_id = 2,bias_hierarchy = 2,flat_id = 1,flat_hierarchy = 2,keep_origin = True,outpath="samedir",debug = False):
